...
import { BiCalendarAlt, BiChevronRight, BiDownload, BiExtension, BiLogOut, BiNews } from "react-icons/bi"
...
export function MainSidebar() {
    ...
    return (
        <>
            ...
            {/* Removed legacy "Connect AniList Account" modal in favor of /login page */}
